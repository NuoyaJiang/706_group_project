...
chart_trend_incident = alt.Chart(subset).mark_line(point=True).encode(
    ...
    color=alt.Color('country:N'),
    tooltip=['year:O', alt.Tooltip("e_inc_num:Q", title="TB cases"), 'country']
).transform_filter(
    selector
).properties(
...
chart_trend_rate_resis = alt.Chart(subset).mark_line(point=True).encode(
    ...
    color=alt.Color('country:N'),
    tooltip=['year:O', alt.Tooltip("success_rate_resistant:Q", title="TB Treatment Success Rate (%)"), 'country']
).transform_filter(
    selector
).properties(
...
chart_trend_incident_resis = alt.Chart(subset).mark_line(point=True).encode(
    ...
    color=alt.Color('country:N'),
    tooltip=['year:O', alt.Tooltip("incidence_resistant:Q", title="TB cases"), 'country']
).transform_filter(
    selector
).properties(
